...
namespace Try2
{
    public partial class Form1 : Form
    {
        ...
        private void CrearBoletin(string rutaArchivoExcel)
        {
            ...
            MessageBox.Show("El boletín de notas se ha creado y guardado exitosamente en " + rutaArchivo, "Boletín Creado", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
